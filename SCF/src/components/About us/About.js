        ...
        <div className="about-container">
            ...
            <h2 className="Offer2Header">Why Choose Us</h2>
                ...
                <div className="choose-grid">
                    ...
                    <div className="ChooseText">
                        <svg  className='svgIcon' xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" style={{position:"relative",right:"90px",top:"50px"}}>
                    ...
                    <div className="ChooseText">
                        <svg className='svgIcon' xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" style={{position:"relative",right:"130px",top:"50px"}}>
